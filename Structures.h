...
const int PERSONS_UCN_LENGTH = 16;
...
/// <summary>
/// Äèñêîâà ñòðóêòóðà çà òàáëèöàòà CITIES
/// </summary>
struct CITIES
{
	long lID;
	...
	bool operator!=(const CITIES& other) const
	{
		return (_tcscmp(szCityName, other.szCityName) != 0) ||
			(_tcscmp(szDistrict, other.szDistrict) != 0);
	}
...
/// <summary>
/// Äèñêîâà ñòðóêòóðà çà òàáëèöàòà PERSONS
/// </summary>
struct PERSONS
{
	long lID;
	...
	bool operator==(const PERSONS& other) const
	{
		return (lID == other.lID) && 
			...
			(_tcscmp(szFirstName, other.szFirstName) == 0) &&
			(_tcscmp(szMiddleName, other.szMiddleName) == 0) &&
			(_tcscmp(szLastName, other.szLastName) == 0) &&
			(_tcscmp(szUCN, other.szUCN) == 0) &&
			(_tcscmp(szAddress, other.szAddress) == 0);
	}
	bool operator!=(const PERSONS& other) const
	{
		return !(*this == other);
...
/// <summary>
/// Äèñêîâà ñòðóêòóðà çà òàáëèöàòà PHONE_TYPES
/// </summary>
struct PHONE_TYPES
{
	long lID;
...
/// <summary>
///  Äèñêîâà ñòðóêòóðà çà òàáëèöàòà PHONE_NUMBERS
/// </summary>
